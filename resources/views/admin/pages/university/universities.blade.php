                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu" role="menu">
                                                <a class="dropdown-item status-items" data-url="{{url('admin/university/'.$value->id.'/status')}}" data-id="{{$value->id}}" data-status="{{$status['wait']}}">{{__('global_waiting')}}</a>
                                                <a class="dropdown-item status-items" data-url="{{url('admin/university/'.$value->id.'/status')}}" data-id="{{$value->id}}" data-status="{{$status['active']}}">{{__('global_active')}}</a>
                                                <a class="dropdown-item status-items" data-url="{{url('admin/university/'.$value->id.'/status')}}" data-id="{{$value->id}}" data-status="{{$status['block']}}">{{__('global_block')}}</a>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="text-right">
